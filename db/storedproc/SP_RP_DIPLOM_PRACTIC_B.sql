...
create or alter procedure sp_rp_diplom_practic_b (
    studentid bigint,
  ...
  for
    select SM.DISCIPLINEID, GD.DISCIPLINE, GD.DISCIPLINE_ENG,
      ...
      where SM.STUDENTID = :STUDENTID
        and SM.DISCIPLINETYPE = 'П'  -- практики
...
GRANT SELECT ON V_LASTSESSIONMARKS TO PROCEDURE SP_RP_DIPLOM_PRACTIC_B;
GRANT SELECT ON V_GUIDE_DISCIPLINE TO PROCEDURE SP_RP_DIPLOM_PRACTIC_B;
GRANT SELECT ON V_GUIDE_FORMREPORT TO PROCEDURE SP_RP_DIPLOM_PRACTIC_B;
GRANT SELECT ON STUDENTPRACTICEINFO TO PROCEDURE SP_RP_DIPLOM_PRACTIC_B;
GRANT SELECT ON STUDENT2VARIANT TO PROCEDURE SP_RP_DIPLOM_PRACTIC_B;
GRANT SELECT ON DISCIPLINE_EDULEVEL TO PROCEDURE SP_RP_DIPLOM_PRACTIC_B;
GRANT SELECT ON V_GUIDE_MARKTYPE TO PROCEDURE SP_RP_DIPLOM_PRACTIC_B;
GRANT SELECT ON V_STUDENT_DISCIPLINES_LAST TO PROCEDURE SP_RP_DIPLOM_PRACTIC_B;
GRANT SELECT ON B_VARIANT_ITEMS TO PROCEDURE SP_RP_DIPLOM_PRACTIC_B;
GRANT SELECT ON B_VARIANT_MODULE TO PROCEDURE SP_RP_DIPLOM_PRACTIC_B;
GRANT SELECT ON B_VARIANT_DISCIPLINE TO PROCEDURE SP_RP_DIPLOM_PRACTIC_B;
GRANT SELECT ON V_GUIDE_FORMREPORT_B TO PROCEDURE SP_RP_DIPLOM_PRACTIC_B;
GRANT SELECT ON RANKING_PROTOCOLS TO PROCEDURE SP_RP_DIPLOM_PRACTIC_B;
GRANT SELECT ON STUDENT2PROTOCOL TO PROCEDURE SP_RP_DIPLOM_PRACTIC_B;
GRANT SELECT ON V_GUIDE_TRADITIONAL_MARK TO PROCEDURE SP_RP_DIPLOM_PRACTIC_B;

/* Existing privileges on this procedure */

GRANT EXECUTE ON PROCEDURE SP_RP_DIPLOM_PRACTIC_B TO SYSDBA;
GRANT EXECUTE ON PROCEDURE SP_RP_DIPLOM_PRACTIC_B TO CONTINGENT_OPERATOR;
GRANT EXECUTE ON PROCEDURE SP_RP_DIPLOM_PRACTIC_B TO CONTINGENT_REPLICATOR;